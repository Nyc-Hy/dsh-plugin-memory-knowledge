  ...
  private projectWikiRun(run: WikiRun): MemoryUiWikiRunSummary {
    ...
    return {
      ...
      businessQuestions: {
        ...
        requiredQuestionCount: run.businessQuestions.requiredQuestionCount,
        analysisTaskCount: run.businessQuestions.analysisTaskCount,
        completedTaskCount: run.businessQuestions.completedTaskCount,
        evidenceFindingCount: run.businessQuestions.evidenceFindingCount,
        unknownFindingCount: run.businessQuestions.unknownFindingCount,
        notApplicableFindingCount: run.businessQuestions.notApplicableFindingCount,
      },
